    ...
    scenarios: [
      {
        name: "프리스위치",
        players: [
          { number: 1, team: "defense", path: [[64, 270], [151, 184], [236, 341]] },
          { number: 2, team: "defense", path: [[434, 262]] },
          { number: 3, team: "defense", path: [[51, 416]] },
          { number: 4, team: "defense", path: [[273, 87], [149, 184], [193, 435]] },
          { number: 5, team: "defense", path: [[340, 287]] },
          { number: "X1", team: "defense", opponent: true, path: [[269, 65], [137, 162], [227, 296]] },
          { number: "X2", team: "defense", opponent: true, path: [[436, 235]] },
          { number: "X3", team: "defense", opponent: true, path: [[24, 407]] },
          { number: "X4", team: "defense", opponent: true, path: [[49, 258], [135, 191], [167, 419]], screenAt: 1 },
          { number: "X5", team: "defense", opponent: true, path: [[334, 260]] },
        ],
        ball: [
          { holder: "X1", at: 0 },
        ],
