...
//
// ⚠ 선수는 **뒤에만 추가할 것.** 인쇄해 둔 기록지가 이 배열의 *순서*를 버블로 가리키고
//   있어서(sheetform.js 의 이름 칸), 중간에 끼워 넣거나 지우면 이미 뽑아 놓은 종이가
//   엉뚱한 사람을 가리킨다. 판독 화면이 "종이에 찍힌 이름과 이 기기에 적어둔 명단이
//   다릅니다"로 잡아 주기는 하지만, 애초에 순서를 안 흔드는 게 낫다.
//
